...
public final class Card
{
	...
	{ ACE, TWO, THREE, FOUR, FIVE, SIX,
		SEVEN, EIGHT, NINE, TEN, JACK, QUEEN, KING, JOCKER }
...
//	}
	...
	public Card(Rank pRank){
		if (!pRank.equals(Rank.JOCKER)){
			throw new IllegalStateException("Must be Jocker.");
		}
		aRank = pRank;
		aSuit = Suit.CLUBS;
	}
	...
	{
		if (aRank.equals(Rank.JOCKER)) return aRank.toString();
	...
	public boolean equals( Object pCard ) 
	{
		...
		if ( ((Card) pCard).getRank().equals(Rank.JOCKER) || aRank.equals(Rank.JOCKER)){
			return ((Card) pCard).getRank().equals(aRank);
		}
